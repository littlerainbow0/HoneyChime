        ...
        <div className='relative mx-auto mt-10 overflow-hidden lg:mt-40 '>
            <div className="relative flex justify-center w-full h-[500px] md:h-[700px] lg:h-[800px] xl:h-[900px]">
                ...
                {/* 圖卡片1  */}
                 ...
                 {/* 文卡片1  */}
                <div className="absolute left-1/4 w-3/5 bg-[#ffffff] shadow-lg transform -translate-x-1/3 translate-y-[0%] z-20 border border-solid border-[#8F755A] mx-auto hover:opacity-30 md:w-1/3 sm:w-2/5 md:translate-y-[40%] lg:translate-y-[20%] 2xl:w-1/4 2xl:translate-y-[0%] 3xl:-translate-y-[10%]">
                    ...
                    {/* 限制段落高度  */}
                    <p className="p-2 mb-2 overflow-y-auto font-normal text-left font-bodyFont text-p-3 sm:text-p-3 md:text-p-2 lg:text-p-1 text-indent-1 lg:p-5 xl:px-20 xl:pb-16">
            ...
            <div className="relative mx-auto mt-40 lg:mt-30 md:mb-10">
                ...
                {/* 文卡片2  */}
                <div className="absolute w-3/5 bg-[#ffffff] shadow-lg transform -translate-y-[80%] z-20 border border-solid border-[#8F755A] mx-auto hover:opacity-30 md:w-1/3 sm:w-2/5 md:-translate-y-[90%] lg:-translate-y-[95%] 2xl:w-1/4 2xl:-translate-y-[95%] 3xl:translate-y-[0%] right-5 md:right-20 lg:right-40 xl:right-52 2xl:right-60">
                    <h1 className="text-[#634A34] mx-2 pr-2 text-left font-titleFont text-h5 sm:text-h4 md:text-h3 lg:text-h2 font-bold  mb-1 mt-4 lg:px-5 xl:px-10 xl:py-5">
                        甜點選材與工藝 
                    </h1>
                    {/* 限制段落高度  */}
            ...
            <div className="relative flex justify-center w-full h-[500px] md:h-[700px] lg:h-[800px] xl:h-[900px] mt-10 sm:mt-60 md:mt-40 lg:mt-72 2xl:mt-[600px]">
                ...
                {/* 圖卡片3  */}
                 ...
                 {/* 文卡片3  */}
                <div className="absolute left-1/4 w-3/5 bg-[#ffffff] shadow-lg transform -translate-x-1/3 translate-y-[70%] z-20 border border-solid border-[#8F755A] mx-auto hover:opacity-30 md:w-1/3 sm:w-2/5 md:translate-y-[40%] lg:translate-y-[20%] 2xl:w-1/4 2xl:translate-y-[0%] 3xl:-translate-y-[10%]">
                    <h1 className="text-[#634A34] mx-2 pr-2 text-left font-titleFont text-h5 sm:text-h4 md:text-h3 lg:text-h2 font-bold  mb-1 mt-4 lg:px-5 xl:px-10 xl:py-5">
                        接待導覽
                    </h1>
                    {/* 限制段落高度  */}
            ...
            <div className="relative mx-auto mt-40 lg:mt-30 ">
                <div className="relative flex justify-center w-full h-[600px] md:h-[700px] lg:h-[800px] xl:h-[1100px]">
                    {/* 圖卡片4  */}
                    <div className="relative w-full max-w-[90%] z-10 mx-auto sm:max-w-[80%]">
                ...
                {/* 文卡片4  */}
                <div className="absolute w-3/5 bg-[#ffffff] shadow-lg transform -translate-y-[120%] z-20 border border-solid border-[#8F755A] mx-auto hover:opacity-30 md:w-1/3 sm:w-2/5 md:-translate-y-[130%] lg:-translate-y-[140%] 2xl:w-1/4 2xl:-translate-y-[140%] right-5 md:right-20 lg:right-40 xl:right-52 2xl:right-60">
                    <h1 className="text-[#634A34] mx-2 pr-2 text-left font-titleFont text-h5 sm:text-h4 md:text-h3 lg:text-h2 font-bold  mb-1 mt-4 lg:px-5 xl:px-10 xl:py-5">
                    服務承諾
                    </h1>
                    {/* 限制段落高度  */}
